...
class ResponseGuardTests(unittest.TestCase):
    ...
    def test_pre_tool_hook_does_not_start_for_unrelated_file_edits(self):
        ...
        self.assertRegex(matcher, r"Skill")
    ...
    def test_current_skill_docs_do_not_contain_known_p0_hallucinations(self):
        selected = (
            PLUGIN_ROOT / "skills" / "avatar-grill" / "SKILL.md",
            PLUGIN_ROOT / "skills" / "avatar-grill" / "references" / "modules" / "avatar-knowledge-base" / "source-skill.md",
            PLUGIN_ROOT / "skills" / "avatar-grill" / "references" / "modules" / "avatar-transparent-bg" / "source-skill.md",
        )
        combined = "\n".join(
